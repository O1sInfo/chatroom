...
class ChatRoom(object):
    ...
    def __init__(self, server, name, username, password=None):
        """
        ChatRoom ID is auto generated from server's room count history.
        :param server: Pointer to server object that instantiated this class
    ...
    def remove_client(self, username):
        ...
        try:
            ...
            print(color_error('Client not in chatroom: {}'.format(self.name)))
